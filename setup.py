...
setup(name = 'cuda_compress',
    description = 'Compress astronomical data',
    author = 'Gilbert Hsyu and Aaron Parsons',
    version = '0.0.0',
    package_dir = {'cuda_compress':'src'},
    packages = ['cuda_compress'],
    ext_modules = [
        CudaExtension('cuda_compress._fft', ['src/_fft/wrap_fft.c'],
            cuda_sources = ['src/_fft/2dfft.cu'],
            include_dirs = ['src/_fft', numpy.get_include()],)
    ],
