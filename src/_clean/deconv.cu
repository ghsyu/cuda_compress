...
template<typename T> struct Clean {
    ...
    static int clean_2d_r(PyArrayObject *res, PyArrayObject *ker,
        ...
        T *dev_ker, *dev_res, *dev_max, *dev_mmax, *dev_step, *dev_nscore, *dev_val_arr;
        ...
        for (int i=0; i < maxiter; i++) {
            ...
            CudaCheckError();
            CudaSafeCall(cudaMemcpy(&val_arr, dev_val_arr, sizeof(T*dim1*dim2), cudaMemcpyDeviceToHost));
            for (int n1=0; n1 < dim1; n1++) {
